...
# Tipos de logs por dispositivo

<img width="859" height="481" alt="image" src="https://github.com/user-attachments/assets/d3e236e0-76ab-4677-b91d-a4548bd51c0c" />

Para analisar e interpretar logs, deve-se entender os diferentes tipos de logs e as informações que eles contém, assim como, os logs que o FortiAnalyzer coleta de cada dispositivo suportado. 

Os logs mostrados no FortiAnalyzer são dependentes do tipo de dispositivo que registrou o log e das funcionalidades habilitadas. Por exemplo, um dispositivo Fortigate gera três tipos de logs: logs de tráfego, logs de eventos e logs de segurança. Cada tipo de log tem subtipos de logs correspondentes. 
